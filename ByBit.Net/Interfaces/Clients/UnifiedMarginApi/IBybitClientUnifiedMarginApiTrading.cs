...
namespace Bybit.Net.Interfaces.Clients.UnifiedMarginApi
{
    ...
    public interface IBybitClientUnifiedMarginApiTrading
    {
        ...
        /// <param name="triggerPrice">Trigger price. If you're expecting the price to rise to trigger your conditional order, make sure triggerPrice > max(market price, basePrice) else, triggerPrice < min(market price, basePrice)</param>
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<BybitUnifiedMarginOrderId>> ModifyOrderAsync(Category category, string symbol, string? orderId = null, string? clientOrderId = null, OrderFilter? orderFilter = null, decimal? iv = null, decimal? triggerPrice = null, decimal? quantity = null, decimal? price = null, decimal? takeProfitPrice = null, decimal? stopLossPrice = null, TriggerType? takeProfitTriggerType = null, TriggerType? stopLossTriggerType = null, TriggerType? triggerType = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<BybitUnifiedMarginOrderId>> CancelOrderAsync(Category category, string symbol, string? orderId = null, string? clientOrderId = null, OrderFilter? orderFilter = null, long? receiveWindow = null, CancellationToken ct = default);
