...
namespace Bybit.Net.Interfaces.Clients.UnifiedMarginApi
{
    ...
    /// </summary>
    public interface IBybitClientUnifiedMarginApiExchangeData
    {
        /// <summary>
        /// Get the server time
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<BybitUnifiedMarginCursorPage<IEnumerable<BybitUnifiedMarginSymbol>>>> GetSymbolsAsync(Category category, string? symbol = null, string? baseAsset = null, int? limit = null, string? cursor = null, long? receiveWindow = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<BybitUnifiedMarginTicker>>> GetTickerAsync(Category category, string? symbol = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<BybitUnifiedMarginOrderBookEntry>> GetOrderBookAsync(string symbol, Category? category = null, int? limit = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<BybitUnifiedMarginOpenInterest>>> GetOpenInterestAsync(Category category, string symbol, OpenInterestInterval interval, DataPeriod period, DateTime? from = null, DateTime? to = null, int? limit = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<BybitUnifiedMarginFundingRate>>> GetFundingRateAsync(Category category, string symbol, DateTime? from = null, DateTime? to = null, int? limit = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<BybitUnifiedMarginRiskLimit>>> GetRiskLimitAsync(Category category, string symbol, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<BybitCursorPage<IEnumerable<BybitUnifiedMarginOptionDeliveryPrice>>>> GetOptionDeliveryPriceAsync(Category? category = null, string? symbol = null, string? baseAsset = null, int? limit = null, string? cursor = null, CancellationToken ct = default);
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<IEnumerable<BybitUnifiedMarginTrade>>> GetTradeHistoryAsync(Category category, string symbol, string? baseAsset = null, OptionType? optionType = null, int? limit = null, CancellationToken ct = default);
    }
}