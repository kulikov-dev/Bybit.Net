...
namespace Bybit.Net.Interfaces.Clients.UnifiedMarginApi
{
    ...
    public interface IBybitClientUnifiedMarginApiAccount
    {
        ...
        /// <param name="ct">Cancellation token</param>
        /// <returns></returns>
        Task<WebCallResult<BybitUnifiedMarginCursorPage<IEnumerable<BybitUnifiedMarginPosition>>>> GetPositionAsync(Category category, string? symbol = null, string? baseAsset = null, SearchDirection? direction = null, int? limit = null, string? cursor = null, long? receiveWindow = null, CancellationToken ct = default);
