...
namespace Bybit.Net.Clients.UnifiedMarginApi
{
    ...
    internal class BybitClientUnifiedMarginApi : RestApiClient, IBybitClientUnifiedMarginApi
    {
        internal static TimeSyncState TimeSyncState = new TimeSyncState("Unified Margin Api");
        internal BybitClientOptions ClientOptions { get; }

        /// <inheritdoc />
        public IBybitClientUnifiedMarginApiAccount Account { get; }
        /// <inheritdoc />
        public IBybitClientUnifiedMarginApiExchangeData ExchangeData { get; }
        /// <inheritdoc />
        public IBybitClientUnifiedMarginApiTrading Trading { get; }

        #region ctor
        internal BybitClientUnifiedMarginApi(Log log, BybitClientOptions options)
            : base(log, options, options.UnifiedMarginApiOptions)
        {
            ...
            Account = new BybitClientUnifiedMarginApiAccount(this);
            ExchangeData = new BybitClientUnifiedMarginApiExchangeData(this);
            Trading = new BybitClientUnifiedMarginApiTrading(this);
