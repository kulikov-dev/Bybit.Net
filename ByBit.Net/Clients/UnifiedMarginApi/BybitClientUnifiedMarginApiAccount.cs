...
namespace Bybit.Net.Clients.UnifiedMarginApi
{
    ...
    public class BybitClientUnifiedMarginApiAccount : IBybitClientUnifiedMarginApiAccount
    {
        ...
        internal BybitClientUnifiedMarginApiAccount(BybitClientUnifiedMarginApi baseClient)
        {
        ...
        public async Task<WebCallResult<IEnumerable<BybitUnifiedMarginCoinExchangeResult>>> ExchangeCoinsAsync(string? fromCoin = null, string? toCoin = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            var result = await _baseClient.SendRequestAsync<BybitUnifiedMarginCoinExchangeResultWrapper>(_baseClient.GetUrl("asset/v2/private/exchange/exchange-order-all"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
            if (!result || result.Data == null)
                return result.As<IEnumerable<BybitUnifiedMarginCoinExchangeResult>>(default);

            if (result.Data.ExchangeResults == null)
                return result.As<IEnumerable<BybitUnifiedMarginCoinExchangeResult>>(Array.Empty<BybitUnifiedMarginCoinExchangeResult>());

            return result.As(result.Data.ExchangeResults);
        }
        ...
        public async Task<WebCallResult<IEnumerable<BybitUnifiedMarginBorrowRate>>> GetBorrowRateAsync(string? asset = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            ...
            var result = await _baseClient.SendRequestAsync<BybitUnifiedMarginBorrowRateWrapper>(_baseClient.GetUrl("unified/v3/private/account/borrow-history"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
            if (!result || result.Data == null)
                return result.As<IEnumerable<BybitUnifiedMarginBorrowRate>>(default);

            if (result.Data.BorrowRates == null)
                return result.As<IEnumerable<BybitUnifiedMarginBorrowRate>>(Array.Empty<BybitUnifiedMarginBorrowRate>());

            return result.As(result.Data.BorrowRates);
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BybitUnifiedMarginCursorPage<IEnumerable<BybitUnifiedMarginPosition>>>> GetPositionAsync(Category category, string? symbol, string? baseAsset, SearchDirection? direction, int? limit, string? cursor, long? receiveWindow, CancellationToken ct)
        {
            var parameters = new Dictionary<string, object>()
            {
            ...
            return await _baseClient.SendRequestAsync<BybitUnifiedMarginCursorPage<IEnumerable<BybitUnifiedMarginPosition>>>(_baseClient.GetUrl("unified/v3/private/position/list"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BybitUnifiedMarginCursorPage<IEnumerable<BybitUnifiedMarginTransactionLog>>>> GetTransactionLogAsync(Category category, string asset, string? baseAsset, DateTime? startTime, DateTime? endTime, SearchDirection? direction, int? limit, string? cursor, long? receiveWindow, CancellationToken ct)
        {
            var parameters = new Dictionary<string, object>()
            {
                { "category", EnumConverter.GetString(category) },
            ...
            return await _baseClient.SendRequestAsync<BybitUnifiedMarginCursorPage<IEnumerable<BybitUnifiedMarginTransactionLog>>>(_baseClient.GetUrl("unified/v3/private/account/transaction-log"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        }
        ...
        /// <inheritdoc />
        public async Task<WebCallResult<BybitUnifiedMarginCursorPage<IEnumerable<BybitUnifiedMarginPnlEntry>>>> GetProfitAndLossHistoryAsync(Category category, string? symbol = null, string? baseAsset = null, string? orderId = null, string? clientOrderId = null, OrderFilter? orderFilter = null, DateTime? startTime = null, DateTime? endTime = null, TradeType? type = null, SearchDirection? direction = null, int? limit = null, string? cursor = null, long? receiveWindow = null, CancellationToken ct = default)
        {
            var parameters = new Dictionary<string, object>()
            {
                { "category", EnumConverter.GetString(category) },
            ...
            return await _baseClient.SendRequestAsync<BybitUnifiedMarginCursorPage<IEnumerable<BybitUnifiedMarginPnlEntry>>>(_baseClient.GetUrl("/unified/v3/private/execution/list"), HttpMethod.Get, ct, parameters, true).ConfigureAwait(false);
        }
