...
namespace Bybit.Net.Objects.Models.UnifiedMargin
{
    ...
    public class BybitUnifiedMarginBalance
    {
        ...
        /// <summary>
        /// Perpetual floating P&L of the account converted into USD: ∑ Asset Perp UPL Base Coin
        /// </summary>
        ...
        /// </summary>
        [JsonProperty("coin")]
        public IEnumerable<BybitBalanceAssetUpdate> Assets { get; set; } = new List<BybitBalanceAssetUpdate>();
    }

    public class BybitBalanceAssetUpdate
    {
        /// <summary>
