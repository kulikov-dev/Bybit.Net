...
namespace Bybit.Net.Objects.Models.UnifiedMargin
{
    ...
    /// Wrapper for ticker
    /// </summary>
    public class BybitUnifiedMarginTickerWrapper
    {
        /// <summary>
        ...
        /// </summary>
        [JsonProperty("list")]
        public IEnumerable<BybitUnifiedMarginTicker> Tickers { get; set; } = Array.Empty<BybitUnifiedMarginTicker>();
    }

    /// <summary>
    /// Ticker
    /// </summary>
    public class BybitUnifiedMarginTicker
    {
        /// <summary>
        /// Symbol
        /// </summary>
